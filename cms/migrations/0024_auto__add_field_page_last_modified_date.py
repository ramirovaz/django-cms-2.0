...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.last_modified_date'
        db.add_column('cms_page', 'last_modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Page.last_modified_date'
        db.delete_column('cms_page', 'last_modified_date')
