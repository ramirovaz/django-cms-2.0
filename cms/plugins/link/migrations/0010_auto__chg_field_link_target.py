...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Link.target'
        db.alter_column('cmsplugin_link', 'target', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        'link.link': {
            ...
            'target': ('django.db.models.fields.CharField', [], {'default': "'_self'", 'max_length': '150'}),
