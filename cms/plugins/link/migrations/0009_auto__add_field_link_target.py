...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cmsplugin_link', 'target', self.gf('django.db.models.fields.CharField')(default='_self', max_length=15), keep_default=False)
    ...
    models = {
        ...
        'link.link': {
            ...
            'target': ('django.db.models.fields.CharField', [], {'default': "'_self'", 'max_length': '15'}),
